...
public:
	...
	virtual void DoAnimationEvent( PlayerAnimEvent_t event, int nData ) OVERRIDE;
	virtual int CalcAimLayerSequence( float *flCycle, float *flAimSequenceWeight, bool bForceIdle ) OVERRIDE;
	virtual float SetOuterBodyYaw( float flValue ) OVERRIDE;
	...
	virtual bool ShouldUpdateAnimState() OVERRIDE { return true; }
...
int CTFCPlayerAnimState::CalcAimLayerSequence(float *flCycle, float *flAimSequenceWeight, bool bForceIdle )
{
